      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2 class="sky_blue">Trade Cash Form</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div id="app" class="x_content">
                    ...
                    <form method="POST"  action="<?php $_PHP_SELF ?>" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" onsubmit="return checkForm(this);">
                      ...
                      <div class="form-group">
                        ...
                        <?php if(!$checktradingexists): ?>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input min="1000" max="<?php echo $tradinguser[0]['Accnt_Bal']; ?>" type="number" id="amt" name="amt" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                        <?php endif; ?>
                        <?php if($checktradingexists): ?>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input readonly="readonly" min="5000" max="<?php echo $tradinguser[0]['Accnt_Bal']; ?>" type="number" id="amt" name="amt" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                        <?php endif; ?>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <input hidden style="display:none;" name="submit" value="tradecash" required="required" class="form-control col-md-7 col-xs-12">
                          <button type="submit" name="trading" class="btn btn-info" id="trade">Trade</button>
                          <?php endif; ?>
                        </div>
                      </div>
