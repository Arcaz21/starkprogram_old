          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2 class="sky_blue">Referral Group</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        <?php error_reporting(E_ERROR | E_PARSE); foreach ($getdownline as $index => $donwline): ?>
                        <tr>
                          <td><?php echo $donwline['Upline_ID']; ?></td>
                          <td><?php echo $donwline['Downline_Name']; ?></td>
                          <td><?php echo $donwline['Account_Name']; ?></td>
                          <td><?php $date = date_create(date('Y-m-d', strtotime($donwline['Date_Created'])));
