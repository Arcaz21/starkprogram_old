            ...
            <div id="app" class="x_content">
              ...
              <form method="POST" action="<?php $_PHP_SELF ?>" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" onsubmit="return checkForm(this);">
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input value="<?php if ($databal->accbal - $getsettings[0]['system_fee'] < 0) : echo NULL;
                                  ...
                                  endif; ?>" min="1"  type="number" name="amount" required="required" class="form-control col-md-7 col-xs-12" max="<?php echo $databal->accbal?>">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="mpin"><i class="fa fa-gg"></i><?php echo $databal->accbal ?>.00
                    </label>
                    <input v-bind:value='amount' type="hidden" id="eamount" name="eamount" required="required" class="form-control col-md-7 col-xs-12">
                  </div>
                </div>
                <input value="<?php echo $getdtmwalletid->wallid ?>" type="hidden" id="wallid" name="wallid" required="required" class="form-control col-md-7 col-xs-12">
                <div class="ln_solid"></div>
                <div class="form-group">
                  <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    <button class="btn btn-danger" type="button">Cancel</button>
                    <input hidden style="display:none;" name="submit" value="reqdtm30encash" required="required" class="form-control col-md-7 col-xs-12">
