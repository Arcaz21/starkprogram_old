          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2 class="sky_blue">Summary Report</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <div class="col-md-4" style="margin-bottom: 3%">
                        Enter Starting and End Date
                            ...
                            <div class="control-group">
                              <div class="controls">
                                <div class="input-prepend input-group">
                                  ...
                                  <input type="text" style="width: 200px" name="reservation" id="reservation" class="form-control" value="07/08/2019 - 08/02/2019" />
                                </div>
                              </div>
                            </div>
                          </fieldset>
