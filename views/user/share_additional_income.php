                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <table id="datatable-fixed-header" class="table table-hover table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        <?php error_reporting(E_ERROR | E_PARSE); foreach ($getsharedr as $index => $direct): 
                        ...
                        <?php endif; ?>
                          ...
                          <td><?php echo number_format($direct['value'],2); ?></td>
                          <td><?php $date = date_create(date('Y-m-d', strtotime($direct['Date_Created'])));
