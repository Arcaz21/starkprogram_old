                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        <?php error_reporting(E_ERROR | E_PARSE); foreach ($useravailpins as $index => $pins): ?>
                        <tr>
                          <td><?php echo $pins['Trade_PIN1'] ?></td>
                          <td><?php echo $pins['Trade_PIN2'] ?></td>
                          <td><?php echo $pins['Date_Connected'] ?></td>
                        </tr>
                        <?php endforeach; ?>
                      </tbody>
                    </table>
