                    ...
                    <form method="POST"  action="<?php $_PHP_SELF ?>" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div  class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input value="" min="0" v-on:input= "update_amount" type="number" name="amount" required="required" class="form-control col-md-7 col-xs-12" max="<?php echo $databal->accbal-$getsettings[0]['system_fee']; ?>">
                      ...
                      <input value="<?php echo $getwalletid->walid?>" type="hidden" id="wallid" name="wallid" required="required" class="form-control col-md-7 col-xs-12">
...
<?php include "loading/finishloading.php"; ?><?php
require __DIR__."/structure/session.php";
include __DIR__."/../../controllers/userFunctions.php";
//echo '<pre>' . print_r($_SESSION, TRUE) . '</pre>';
?>
