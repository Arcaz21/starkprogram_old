        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2 class="sky_blue">Transfer to Holdings Wallet</h2>
                  <div class="clearfix"></div>
                </div>
                  ...
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="amt">Your Current BDCoins: <span class="required" style="color:red;"> <?php echo number_format($databal->accbal,2); ?></span>
                    ...
                    <div class="form-group">
                      <div class="col-md-6 col-md-offset-3">
                        <button id="send" type="submit" name="submit" value="transferholdingswallet" class="btn btn-info">Transfer</button>
                      </div>
                    </div>
                  </form>
                </div>
  ...
  <script type="text/javascript">
    function notifyUser(message) {
      ...
      if (message == "sendtoself") {
        new PNotify({
          title: 'Error Transfer',
          text: 'Can not transfer to own account,
          type: 'error',
          styling: 'bootstrap3'
        });
      }
      ...
      if (message == "usererror") {
        new PNotify({
          title: 'Error Transfer.',
          text: 'The Account You Entered Does Not Exist or is not a holdings account.',
          type: 'error',
          styling: 'bootstrap3'
        });
      }
