      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2 class="sky_blue">Change Password</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div id="app" class="x_content">
                    ...
                    <form method="POST"  action="<?php $_PHP_SELF ?>" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="old_pwd"> Old Password <span class="required">*</span>
                        </label>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="pwd"> New Password <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="pwd"> Retype New Password <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="password" id="retype_pwd" name="retype_pwd" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <button href="change_pass.php" class="btn btn-danger" type="button">Cancel</button>
                          <button type="submit" name="submit" value="tradecash" class="btn btn-info">Change Password</button>
                        </div>
                      </div>
      ...
      function notifyUser(message) {
          if(message == "success") {
              new PNotify({
                ...
                text: 'A new package has been added.<strong><a href="listpackage.php">CHECK IT OUT </a></strong>',
                type: 'success',
                styling: 'bootstrap3'
              });
          }
