                    ...
                    <form method="POST"  action="<?php $_PHP_SELF ?>" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div  class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input value="<?php if($databal->accbal-$getsettings[0]['system_fee'] <0):echo NULL; else:echo $databal->accbal-$getsettings[0]['system_fee'];endif;?>" min="1" v-on:input= "update_amount" type="number" name="amount" required="required" class="form-control col-md-7 col-xs-12"  max="<?php if($databal->accbal-$getsettings[0]['system_fee'] <0):echo 0.00; else:echo $databal->accbal-$getsettings[0]['system_fee'];endif;?>">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="mpin">BDCoins to Peso<span class="required">:</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <button  type="submit" name="submit" value="reqencash" class="btn btn-info">Request</button>
                        </div>
                      </div>
