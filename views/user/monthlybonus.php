          ...
          <div class="">
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2 class="sky_blue">Direct Sponsor Monthly Bonus</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <table id="datatable-fixed-header" class="table table-hover table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        <?php error_reporting(E_ERROR | E_PARSE); foreach ($getmonthlydr as $index => $monthly): ?>
                        <tr>
                          <td><?php echo $monthly['Full_Name']; ?></td>                          
                          <td><?php echo $monthly['Accnt_Name']; ?></td>
                          <td><?php echo $monthly['Package_Name']; ?></td>
                          <td><?php echo number_format($monthly['Business_Value']*.20,2); ?></td>
                          <td><?php echo number_format($monthly['Amount'],2); ?></td>
                          <td><?php $date = date_create(date('Y-m-d', strtotime($monthly['creation_date'])));
